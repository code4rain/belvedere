...
MANAGE:
	...
	Gui Font, s12, Wingdings 3
	Gui, 1: Add, Button, x30 y185 h30 vMoveUpFolder gMoveUpFolder,p
	Gui, 1: Add, Button, x30 y215 h30 vMoveDownFolder gMoveDownFolder,q
	Gui Font, s10, Consolas
	...
	Gui Font, s12, Wingdings 3
	Gui, 1: Add, Button, x675 y185 h30 vMoveUpRule gMoveUpRule,p
	Gui, 1: Add, Button, x675 y215 h30 vMoveDownRule gMoveDownRule,q
	Gui Font, s10, Consolas
	...
	Gui, 1: Add, Text, x70 y60 w80 h20 , Sleeptime:
	Gui, 1: Add, Edit, x150 y58 w70 h20 Number vSleep, %Sleep%
	Gui, 1: Add, DropDownList, x230 y58 w65 vSleeptimeLength, %thisSleeptimeLength%
	Gui, 1: Add, Checkbox, x70 y90 vConfirmExit Checked%ConfirmExit%, Show confirmation dialog on exit
	Gui, 1: Add, Groupbox, x63 y120 w620 h115, Logging/Alert Options
	Gui, 1: Add, Checkbox, x70 y140 vEnableLogging Checked%EnableLogging%, Enable logging for this log type:
	Gui, 1: Add, DropDownList, x330 y138 w60 vLogType, %thisLogTypes%
	Gui, 1: Add, Checkbox, x70 y165 vGrowlEnabled Checked%GrowlEnabled%, Enable support for Growl for Windows`n(you must restart %APPNAME% for this setting to be applied)
	Gui, 1: Add, Checkbox, x70 y205 vTrayTipEnabled Checked%TrayTipEnabled%, Enable support for Notification Area Balloon Tips
	Gui, 1: Add, Groupbox, x63 y237 w620 h70, Default Rule Options
	Gui, 1: Add, Text, x70 y262, The checked state of the following parameters will be the default for newly created rules:
	Gui, 1: Add, Checkbox, x70 y282 w70 h20 vDefault_Enabled Checked%Default_Enabled%, Enabled
	Gui, 1: Add, Checkbox, x140 y282 w130 h20 vDefault_ConfirmAction Checked%Default_ConfirmAction%, Confirm Action
	Gui, 1: Add, Checkbox, x255 y282 w100 h20 vDefault_Recursive Checked%Default_Recursive%, Recursive
	Gui, 1: Add, Groupbox, x63 y320 w620 h70, Command Line Parameters
	Gui, 1: Add, Text, x70 y340, %APPNAME% will accept the following command line parameters:
	Gui, 1: Add, Text, x70 y360, %A_Space%%A_Space%%A_Space%-r <integer>%A_Tab%: the number of times you would like %APPNAME% to run then exit quietly.
	Gui, 1: Add, Button, x62 y392 h30 vSavePrefs gSavePrefs, Save Preferences
	Gui, 1: Add, Button, x520 y392 h30 vVerifyConfig gVerifyConfig, Verify Configuration
